...
def get_moon_json(settings : Settings) -> list:
    ...
    output.append({"set": "Metro|1", "moons": get_all_moons(391, 425, 427, settings), "transition_moon": MOONS[432]['name']})
    output.append({"set": "Metro|2", "moons": get_all_moons(391, 425, 433, settings), "transition_moon": None})
